        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-white font-semibold text-lg">Utilizatori</h3>
                <p className="text-[#8892b0] text-sm">Toate conturile înregistrate</p>
              </div>
            </div>
            <p className="text-[#8892b0] text-sm">Vizualizează toți utilizatorii cu email și data înregistrării</p>
          </button>
        </div>
      </main>
    </div>
